...
export default function OurWork() {
  return (
    <div>
      <Layout>
        {/* Section 1 */}
        <div class="flex flex-wrap items-center fade-in">
        ...
        <div class="flex flex-wrap items-center">
          <div class="bg-white w-full overflow-hidden sm:w-1/2 flex self-stretch items-center place-content-center">
            <img src={peek} alt="peek feature" class="w-4/12" />
          </div>
          <div class="bg-white px-20 py-20 w-full overflow-hidden sm:w-1/2 flex self-stretch items-center">
            <div>
              <h1 class="text-black text-5xl 2xl:text-6xl xl:text-4xl lg:text-2xl md:text-xl">
              ...
              <div>
                <br></br><br></br>
                <q>Did I get my salary?</q>
                <br></br>
                <q>Has my student loan payment gone through?</q><br></br>
                <p class="font-thin text-black text-base 2xl:text-lg xl:text-base lg:text-sm md:text-xs lg:py-6 md:py-2 sm:py-1">
                  It feels good to peek at your balance ‘just to make sure.’
                  <br />
                  <br></br>
                  Peek balance is one of our most popular features. <br></br><br></br>But
                  it wasn’t always so. In fact, in the beginning, no one liked
                  it — our users or our stakeholders. But the user behaviour we
                  had observed told a different story. So we kept at it. And it
                  worked out. 
                  <br></br><br></br>
                  <q>Peek balance is a useful little design solution that nobody thought they wanted.</q>
                  <p class="font-thin italic text-black text-base 2xl:text-lg xl:text-base lg:text-sm md:text-xs lg:py-6 md:py-2 sm:py-1"> - Ed Chu Design Lead, Consumer Banking Group</p>
                </p>
              </div>
            </div>
          </div>
