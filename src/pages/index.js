      ...
      <div class="flex flex-wrap items-center">
        ...
        <div class="bg-red-500 px-20 py-20 w-full overflow-hidden sm:w-1/2 flex self-stretch items-center">
          <div>
            ...
            <p class="text-white text-base 2xl:text-lg xl:text-base lg:text-sm md:text-xs lg:py-6 md:py-2 sm:py-1">
            ...
            <img src={downArrow} alt="Logo" class="animate-bounce duration-500 w-10 p-0"/>
          </div>
        </div>
      </div>
      {/* Section 2 */}
